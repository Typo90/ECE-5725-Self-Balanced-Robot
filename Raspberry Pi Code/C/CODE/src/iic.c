...
int i2cWrite(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *data)
{
	...
	i2c_smbus_write_i2c_block_data(file,reg,len,data);
    return 0;
}
/**************************实现函数********************************************
*函数原型:		bool i2cWrite(uint8_t addr, uint8_t reg, uint8_t data)
...
{
	ioctl(file,I2C_SLAVE,addr);
    i2c_smbus_read_i2c_block_data(file,reg,len,buf);
    return 0;
}
...
返回   读出来的字节数量
*******************************************************************************/ 
uint8_t IICreadBytes(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *buf){
   

    int i;
	ioctl(file,I2C_SLAVE,addr);
    i = i2c_smbus_read_i2c_block_data(file,reg,len,buf);
//	write(file,&reg,1);
  //  i = read(file,buf,len);
...
返回   返回是否成功
*******************************************************************************/ 
uint8_t IICwriteBytes(uint8_t addr, uint8_t reg, uint8_t len, uint8_t* data){
...
返回   1
*******************************************************************************/ 
unsigned char IICwriteByte(unsigned char addr, unsigned char reg, unsigned char data){
    return IICwriteBytes(addr,reg,1,&data);
        /*
	ioctl(file,I2C_SLAVE,addr);
