...
void MPU6050_setClockSource(uint8_t source){
        uint8_t data[1];
        IICreadByte(devAddr,MPU6050_RA_PWR_MGMT_1,data);
...
void MPU6050_setFullScaleGyroRange(uint8_t range) {
        uint8_t data[1];
        IICreadByte(devAddr,MPU6050_RA_GYRO_CONFIG,data);
...
void get_data(int file)
{
    unsigned char a[8];
    int reg;
    //reg = MPU6050_RA_ACCEL_XOUT_H;
    //IICreadBytes(devAddr,reg,8,a);
    //printf("acc x=%d,y=%d,z=%d temp=%d\n",\
                    (int16_t)(a[0]<<8|a[1]),(int16_t)(a[2]<<8|a[3]),(int16_t)(a[4]<<8|a[5]),a[6]<<8|a[7]);
    reg = MPU6050_RA_GYRO_XOUT_H;
    IICreadBytes(devAddr,reg,6,a);
    printf("gyro x=%d,y=%d,z=%d\n",\
                    (int16_t)(a[0]<<8|a[1]),(int16_t)(a[2]<<8|a[3]),(int16_t)(a[4]<<8|a[5]));
}
//------------------End of File----------------------------
